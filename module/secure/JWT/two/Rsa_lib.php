<?
    class Rsa_lib {
        // 비대칭 알고리즘인 RSA를 사용하여 문자열을 암호화하는 법.
        ...
        public function rsa_generate_keys($password, $bits = 2048, $digest_algorithm = 'sha256'){
        ...
        public function rsa_decrypt($ciphertext, $private_key, $password){
            // 암호문을 base64로 디코딩한다.
